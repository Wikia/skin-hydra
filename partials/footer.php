...
$mobileViewUrl = $skin->getTitle()->getFullURL(array('mobileaction' => 'toggle_view_mobile'));
	...
	<div class="footer-wrapper-gp">
		...
		<div class="footer-box footer-links mobile-split">
			<ul>
				...
				<li><a href="http://help.gamepedia.com/How_To_Contact_Gamepedia"><?php echo wfMessage('footer-Contact_Us')->text() ?></a></li>
			</ul>
		</div>
	</div>
</div>
	...
	<div class="footer-wrapper">
		...
		<div class="footer-box footer-social">
			...
			<ul class="social">
				...
				<li><a href="https://www.linkedin.com/company/157252" title="<?php echo wfMessage('footer-Linkedin')->text() ?>"><svg width="19" height="19" xmlns="http://www.w3.org/2000/svg"><path d="M3.859375 19h-3.5625V5.9375h3.5625V19zM2.078125 4.43175C.931 4.43175 0 3.493625 0 2.337S.931.24225 2.078125.24225 4.15625 1.180375 4.15625 2.337s-.929812 2.09475-2.078125 2.09475zM18.109375 19h-3.5625v-6.65475c0-3.9995-4.75-3.6966875-4.75 0V19h-3.5625V5.9375h3.5625v2.0959375c1.65775-3.070875 8.3125-3.2976875 8.3125 2.94025V19z" fill-rule="nonzero" /></svg></a></li>
			</ul>
		</div>
		...
		<div class="footer-box footer-community">
			...
			<ul class="mobile-split">
				...
				<li><a href="https://fandom.zendesk.com/"><?php echo wfMessage('footer-support')->text() ?></a></li>
